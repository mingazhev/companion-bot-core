"""Shared pytest fixtures for TdBot test suite."""
...
import tdbot.config as config_module
...
def test_settings(monkeypatch: pytest.MonkeyPatch) -> Settings:
    ...
    settings = Settings(
        ...
        database_url=SecretStr("postgresql+asyncpg://test:test@localhost:5432/tdbot_test"),
