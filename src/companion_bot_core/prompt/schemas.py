...
DEFAULT_SYSTEM_TEMPLATE = (
    ...
    "\n"
    "Стиль:\n"
    "- ВАЖНО: по умолчанию отвечай коротко — 2-4 предложения. "
    "Длиннее только если пользователь явно просит подробнее, "
    "говорит «расскажи подробно», «разверни» или задаёт сложный вопрос. "
    "Никогда не генерируй списки из 5+ пунктов без запроса.\n"
