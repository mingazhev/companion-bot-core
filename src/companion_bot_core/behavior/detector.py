...
if TYPE_CHECKING:
    from companion_bot_core.behavior.schemas import DetectedIntent
...
def classify(text: str) -> DetectionResult:
    ...
    :data:`~companion_bot_core.behavior.policy.CONFIDENCE_THRESHOLD`, the result is
    ...
    Returns:
        :class:`~companion_bot_core.behavior.schemas.DetectionResult` with all fields set.
    """
