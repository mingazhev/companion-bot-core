...
def check_prompt_injection(text: str) -> GuardrailResult:
    ...
    Returns:
        :class:`~companion_bot_core.policy.schemas.GuardrailResult` with ``allowed=False``
...
def check_risky_capability(text: str) -> GuardrailResult:
    ...
    v1 of Companion Bot Core supports prompt-based skills only.  Requests for code execution,
