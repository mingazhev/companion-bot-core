...
:class:`~companion_bot_core.bot.middleware.IngressMiddleware`, and the command
:data:`~companion_bot_core.bot.handlers.router`.
...
from companion_bot_core.bot.handlers import router
...
def build_dispatcher(
    ...
    Registers:
    - :class:`~companion_bot_core.bot.middleware.IngressMiddleware` as an *outer* middleware
      on every incoming :class:`~aiogram.types.Update`.
    - The command :data:`~companion_bot_core.bot.handlers.router`.
