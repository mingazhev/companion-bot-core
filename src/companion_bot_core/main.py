...
from companion_bot_core.bot.app import build_bot, build_dispatcher
from companion_bot_core.config import get_settings
...
from companion_bot_core.refinement.worker import run_worker
...
async def _run() -> None:
    ...
    try:
        ...
        log.info("companion_bot_core stopped")


def main() -> None:
    """Synchronous entry-point for the ``companion-bot-core`` console script."""
    try:
        asyncio.run(_run())
