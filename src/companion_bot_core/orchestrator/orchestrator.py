...
async def process_message(
    ...
    Args:
        ...
        on_partial_reply:              Optional async callback invoked with each
                                       text chunk during SSE streaming.  When
                                       provided, ``generate_reply_stream`` is
                                       used instead of ``generate_reply``.
