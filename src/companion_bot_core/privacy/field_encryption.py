...
# Uses structlog directly (not companion_bot_core.logging_config) to avoid a circular import:
...
class FieldEncryptor:
    ...
    def from_settings(cls, settings: Settings) -> FieldEncryptor:
        """Construct from application :class:`~companion_bot_core.config.Settings`."""
